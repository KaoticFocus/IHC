...
export const SettingsModal: React.FC<SettingsModalProps> = ({ open, onClose }) => {
  ...
  const loadSettings = async () => {
    try {
      ...
      console.log('Input devices:', devices.filter(d => d.type === 'input'));
      console.log('Output devices:', devices.filter(d => d.type === 'output'));
  ...
  const handleSave = async () => {
    try {
      ...
      if (selectedInput) {
        console.log('Saving input device:', selectedInput);
        await AudioService.setInputDevice(selectedInput);
      }
      if (selectedOutput) {
        console.log('Saving output device:', selectedOutput);
